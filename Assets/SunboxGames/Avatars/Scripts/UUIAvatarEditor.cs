...
namespace Sunbox.Avatars {
    ...
    public class UUIAvatarEditor : MonoBehaviour {
        ...
        [Space(20)]
        // public GameObject ExpressionsPanel;
        // public Button SadnessButton;
        // public Button JoyButton;
        ...
        void Start() {
            ...
            //     //ExpressionsPanel.SetActive(false);
            ...
            //     //ExpressionsPanel.SetActive(true);
            //     //Avatar.SetExpression(AvatarCustomization.AvatarExpression.None);
            //     ClearSectionContent_Internal();
            ...
            // FearButton.onClick.AddListener(() => {
            //     Avatar.SetExpression(AvatarCustomization.AvatarExpression.Fear);
            //     _isZoomed = true;
            // });

            // AngerButton.onClick.AddListener(() => {
            //     Avatar.SetExpression(AvatarCustomization.AvatarExpression.Anger);
            //     _isZoomed = true;
            // });

            // DisgustButton.onClick.AddListener(() => {
            //     Avatar.SetExpression(AvatarCustomization.AvatarExpression.Disgust);
            //     _isZoomed = true;
            // });
            
            // SadnessButton.onClick.AddListener(() => {
            //     Avatar.SetExpression(AvatarCustomization.AvatarExpression.Sadness);
            //     _isZoomed = true;
            // });

            // JoyButton.onClick.AddListener(() => {
            //     Avatar.SetExpression(AvatarCustomization.AvatarExpression.Joy);
            //     _isZoomed = true;
            // });
        ...
        public void saveAvatar () {
            ...
            myRecipe = AvatarCustomization.ToConfigString(Avatar);
            File.WriteAllText(Application.persistentDataPath + "/customizationDataHumanoid.txt", myRecipe);
        }
